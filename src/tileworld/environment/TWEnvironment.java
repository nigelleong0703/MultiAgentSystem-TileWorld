...
import tileworld.agent.AgentFZM;
...
public class TWEnvironment extends SimState implements Steppable {
    ...
    public void start() {
        ...
        Int2D pos3 = this.generateRandomLocation();
        assert (this.isInBounds(pos3.getX(), pos3.getY()));
        createAgent(new AgentFZM(2, "agent3", pos3.getX(), pos3.getY(), this,
                Parameters.defaultFuelLevel));
        Int2D pos4 = this.generateRandomLocation();
        assert (this.isInBounds(pos4.getX(), pos4.getY()));
        createAgent(new AgentFZM(3, "agent4", pos4.getX(), pos4.getY(), this,
                Parameters.defaultFuelLevel));
        Int2D pos5 = this.generateRandomLocation();
        assert (this.isInBounds(pos5.getX(), pos5.getY()));
        createAgent(new AgentFZM(4, "agent5", pos5.getX(), pos5.getY(), this,
                Parameters.defaultFuelLevel));
        // ---------------------------------------------------------------------------------------------------
        //
